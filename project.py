...
#Radio Buttons
rad1 = Radiobutton(window, text="Доклад/сообщение/реферат", value=1)
rad1.grid(column=0, row=3)
rad2 = Radiobutton(window, text="Сборник/каталог/подборка", value=2)
rad2.grid(column=0, row=4)
rad3 = Radiobutton(window, text="Заметки/примечания/записи", value=3)
